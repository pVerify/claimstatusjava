...
public class StatusResponseDriver {
public static final String TOKEN = ""; //Do not include Bearer here, simply paste the token string
	
	public static final String URL = "https://api.pverify.com/API/GetClaimStatusResponse/<code>"; //Insert unique request ID value for <code>
